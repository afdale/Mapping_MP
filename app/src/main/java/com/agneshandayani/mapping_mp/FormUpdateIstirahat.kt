...
class FormUpdateIstirahat : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnmc!!.setOnClickListener {
            val intent = Intent(this@FormUpdateIstirahat, BarcodeScannerActivity::class.java)
    ...
    inner class Douploadreport(var activity: FormUpdateIstirahat) : AsyncTask<String, String, String>() {
        ...
        override fun onPostExecute(s: String) {
            dialog.dismiss()
            Toast.makeText(this@FormUpdateIstirahat, "" + z, Toast.LENGTH_LONG).show()

            if (isSuccess) {
                FirebaseDatabase.getInstance().getReference().child("mapping").child("manpower")
                    .child("ABSENSIP2").child(kunci).removeValue()
